    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-cyan-50 via-white to-sky-50">
            ...
            <div className="max-w-7xl mx-auto px-4 pb-12 sm:pb-16 md:pb-20 space-y-12 sm:space-y-16 md:space-y-20">
                ...
                {/* Kitabi Udan */}
                <div className="group bg-gradient-to-br from-white to-cyan-50 rounded-2xl sm:rounded-3xl shadow-2xl overflow-hidden border-2 border-cyan-200 hover:border-teal-400 hover:shadow-3xl transition-all duration-500 transform hover:-translate-y-2">
                    <div className="p-4 sm:p-6 md:p-8 lg:p-12 relative">
                        <div className="absolute top-0 right-0 w-16 h-16 sm:w-24 sm:h-24 md:w-32 md:h-32 bg-gradient-to-br from-cyan-200 to-teal-200 rounded-full opacity-20 transform translate-x-8 sm:translate-x-12 md:translate-x-16 -translate-y-8 sm:-translate-y-12 md:-translate-y-16"></div>
                        
                        <div className="text-center mb-6 sm:mb-8 md:mb-10 relative z-10">
                            <div className="inline-block p-3 sm:p-4 md:p-6 bg-gradient-to-r from-cyan-100 to-teal-100 rounded-2xl sm:rounded-3xl shadow-lg mb-4 sm:mb-6">
                                <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-teal-600 via-cyan-600 to-sky-600 mb-2 sm:mb-4">
                                    Kitabi Udan
                                </h2>
                                <div className="inline-block px-4 sm:px-6 md:px-8 py-2 sm:py-3 bg-gradient-to-r from-cyan-200 to-teal-200 rounded-full shadow-md">
                                    <p className="text-lg sm:text-xl md:text-2xl font-bold text-teal-900 italic">
                                        "हर पन्ना नई उड़ान"
                                    </p>
                                </div>
                            </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 md:gap-10 items-center mb-6 sm:mb-8">
                            <div className="flex justify-center order-2 md:order-1">
                                <div className="relative group">
                                    <div className="absolute inset-0 bg-gradient-to-r from-teal-400 to-cyan-400 rounded-xl sm:rounded-2xl blur opacity-30 group-hover:opacity-50 transition-opacity duration-300"></div>
                                    <img 
                                        src={kitabi1}
                                        alt="Kitabi Udan poster" 
                                        className="relative w-64 sm:w-72 md:w-80 h-48 sm:h-56 md:h-64 object-cover rounded-xl sm:rounded-2xl shadow-xl border-4 border-cyan-300 hover:border-teal-400 transition-all duration-300 transform hover:scale-105"
                                    />
                                </div>
                            </div>
                            <div className="bg-white/70 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-lg border border-cyan-200 order-1 md:order-2">
                        ...
                        <div className="flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-6 md:gap-8">
                            <div className="relative group">
                                <div className="absolute inset-0 bg-gradient-to-r from-teal-400 to-cyan-400 rounded-xl sm:rounded-2xl blur opacity-20 group-hover:opacity-40 transition-opacity duration-300"></div>
                                <img 
                                    src={kitabi2} 
                                    alt="Kitabi Udan notebook" 
                                    className="relative w-56 sm:w-60 md:w-64 h-40 sm:h-44 md:h-48 object-cover rounded-xl sm:rounded-2xl shadow-xl border-4 border-cyan-300 hover:border-teal-400 transition-all duration-300 transform hover:scale-105"
                                />
                            </div>
                            <div className="relative group">
                                <div className="absolute inset-0 bg-gradient-to-r from-teal-400 to-cyan-400 rounded-xl sm:rounded-2xl blur opacity-20 group-hover:opacity-40 transition-opacity duration-300"></div>
                ...
                {/* Labour's Day */}
                <div className="group bg-gradient-to-br from-white to-teal-50 rounded-2xl sm:rounded-3xl shadow-2xl overflow-hidden border-2 border-teal-200 hover:border-teal-400 hover:shadow-3xl transition-all duration-500 transform hover:-translate-y-2">
                    <div className="p-4 sm:p-6 md:p-8 lg:p-12 relative">
                        <div className="absolute top-0 left-0 w-20 h-20 sm:w-32 sm:h-32 md:w-40 md:h-40 bg-gradient-to-br from-teal-200 to-cyan-200 rounded-full opacity-20 transform -translate-x-10 sm:-translate-x-16 md:-translate-x-20 -translate-y-10 sm:-translate-y-16 md:-translate-y-20"></div>
                        
                        <div className="text-center mb-6 sm:mb-8 md:mb-10 relative z-10">
                            <div className="inline-block p-3 sm:p-4 md:p-6 bg-gradient-to-r from-teal-100 to-cyan-100 rounded-2xl sm:rounded-3xl shadow-lg mb-4 sm:mb-6">
                                <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-teal-600 via-cyan-600 to-sky-600 mb-2 sm:mb-4">
                                    Labour's Day
                                </h2>
                                <div className="w-20 sm:w-24 md:w-32 h-1 sm:h-2 bg-gradient-to-r from-teal-400 to-cyan-400 rounded-full mx-auto shadow-md"></div>
                            </div>
                        </div>
                        
                        <div className="bg-white/70 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 shadow-lg border border-teal-200 mb-6 sm:mb-8">
                        ...
                        <div className="flex justify-center">
                            <div className="relative w-full max-w-xs sm:max-w-lg md:max-w-2xl bg-gradient-to-r from-teal-900 to-cyan-900 rounded-xl sm:rounded-2xl overflow-hidden shadow-2xl border-4 border-teal-300">
